...
im = Image.open("D:/Imagens/fotos akita/teste1.jpeg")
...
for i in range(im.height):
        for j in range(im.width):
            if ((img_hsv[j,i,0])*360 >= 60 and (img_hsv[j, i, 0])*360 <= 140 and img_hsv[j,i,1] >= 0.18  and img_hsv[j,i,2] >= 0.2 and img_hsv[j,i,2] <= 0.8):
